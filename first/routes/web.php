...
Route::post('malfunctions/makegrid', 'MalfunctionController@makeGrid')->name('malfunctionmakeGrid');
...
Route::post('malfunctions/setstatus', 'MalfunctionController@setStatus');
