																 ...
																 <div class="col-lg-7">
																	 @foreach ($catAttribute->attribute_options as $option)
																		<div class="custom-control custom-checkbox custom-control-inline">
																			 <input type="checkbox" id="{{ $catAttribute->input_name }}{{$option->id}}" name="{{ $catAttribute->input_name }}[]" value="{{$option->name}}" class="custom-control-input"
																			 @if (is_array($selectedAttrs) && array_key_exists($catAttribute->input_name,$selectedAttrs))
																				 @php
																				 	$inName = $catAttribute->input_name;
																				 @endphp
																				 @if (is_array($selectedAttrs["$inName"]) && in_array($option->name, $selectedAttrs["$inName"]))
																					 checked
																				 @endif
																			 @endif
																			 >
															...
															<div class="row">
																 ...
																 <div class="col-lg-7">
																	 @foreach ($subAttribute->attribute_options as $option)
																		<div class="custom-control custom-checkbox custom-control-inline">
																			 <input type="checkbox" id="{{ $subAttribute->input_name }}{{$option->id}}" name="{{ $subAttribute->input_name }}[]" value="{{$option->name}}" class="custom-control-input"
															...
															<div class="row">
																 ...
																 <div class="col-lg-7">
																	 @foreach ($childAttribute->attribute_options as $option)
																		<div class="custom-control custom-checkbox custom-control-inline">
																			 <input type="checkbox" id="{{ $childAttribute->input_name }}{{$option->id}}" name="{{ $childAttribute->input_name }}[]" value="{{$option->name}}" class="custom-control-input"
