...
<script>
  ...
  function filter() {
    ...
    if ($("#prod_name").val() != '') {
      if (filterlink == '') {
        filterlink += '{{route('front.category', [Request::route('slug'), Request::route('slug1'), Request::route('slug2')])}}' + '?search='+$("#prod_name").val();
      } else {
    ...
    $(".attribute-input").each(function() {
      if ($(this).is(':checked')) {
        if (filterlink == '') {
          filterlink += '{{route('front.category', [Request::route('slug'), Request::route('slug1'), Request::route('slug2')])}}' + '?'+$(this).attr('name')+'='+$(this).val();
        } else {
    ...
    if ($("#sortby").val() != '') {
      if (filterlink == '') {
        filterlink += '{{route('front.category', [Request::route('slug'), Request::route('slug1'), Request::route('slug2')])}}' + '?'+$("#sortby").attr('name')+'='+$("#sortby").val();
      } else {
    ...
    if ($("#min_price").val() != '') {
      if (filterlink == '') {
        filterlink += '{{route('front.category', [Request::route('slug'), Request::route('slug1'), Request::route('slug2')])}}' + '?'+$("#min_price").attr('name')+'='+$("#min_price").val();
      } else {
    ...
    if ($("#max_price").val() != '') {
      if (filterlink == '') {
        filterlink += '{{route('front.category', [Request::route('slug'), Request::route('slug1'), Request::route('slug2')])}}' + '?'+$("#max_price").attr('name')+'='+$("#max_price").val();
      } else {
  ...
  function addToPagination() {
    ...
    $('ul.pagination li a').each(function() {
      ...
      let fullUrl = '{{route('front.category', [Request::route('slug'),Request::route('slug1'),Request::route('slug2')])}}?page='+page+'&search='+'{{request()->input('search')}}';
