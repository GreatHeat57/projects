        <div class="col-lg-3 col-md-6">
          <div class="left-area">
            ...
            <div class="body-area">
              <form id="catalogForm" action="{{ route('front.category', [Request::route('slug'), Request::route('slug1'), Request::route('slug2')]) }}" method="GET">
            ...
            @if ((!empty($cat) && !empty(json_decode($cat->attributes, true))) || (!empty($subcat) && !empty(json_decode($subcat->attributes, true))) || (!empty($childcat) && !empty(json_decode($childcat->attributes, true))))
              ...
              <div class="tags-area">
                ...
                <div class="body-area">
                  <form id="attrForm" action="{{route('front.category', [Request::route('slug'), Request::route('slug1'), Request::route('slug2')])}}" method="post">
                    <ul class="filter">
